...
{{-- start tab 2 --}}
            ...
            <div class="lightbox lightbox-custom lightbox-confirmation" id="benefit">
                <div class="lightbox-wrapper">
                    <a class="close-btn" href="#close-modal" rel="modal:close">
            ...
            S71,88,50,88z"
                    ...
                    <div class="header">
                        <img id="image" src="https://noel.dv9.com/convert/webp?src=storage/photos/shares/4-part/new-corporatesvc.jpg" />
                        <div style="margin-top: 15px;">
                            <h6 class="modal-date" style="margin-bottom: 15px; font-size: 90%; color: #717171;">25 Jun 2023 - 25 Jul 2023</h6>
...
<script>
    ...
    // Secara default, buka Tab 1
    document.getElementById("Tab1").style.display = "block";
</script>
<script>
    $container = $('.history-box').infiniteScroll({
  // options
  path: '{{url(request()->path()."")}}?page=@{{#}}',
  append: '.s15-table-item',
  history: false,
